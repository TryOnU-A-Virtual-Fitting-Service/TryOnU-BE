...
class HealthCheckServiceImplTest extends BaseServiceTest {
    ...
    class CheckHealth {
        ...
        void checkHealth_Success() {
            ...
            assertThat(result.uptimeSeconds()).isEqualTo(expectedUptimeSeconds);

            // Verify interactions
            then(healthCheckConverter).should().toHealthCheckResponse(eq("UP"), any(LocalDateTime.class), anyLong());
        }
