...
class UserServiceImplTest extends BaseServiceTest {
    ...
    void setUp() {
        ...
        defaultModelDtos = List.of(
                new DefaultModelDto(1L, "https://test-bucket.s3.amazonaws.com/models/default-female-model.jpg",
                        "기본 여성 모델", 1, false),
                new DefaultModelDto(2L, "https://test-bucket.s3.amazonaws.com/models/default-male-model.jpg",
                        "기본 남성 모델", 2, false));
    ...
    class GetCurrentUserSimpleInfo {
        ...
        void getCurrentUserSimpleInfo_Success() {
            ...
            try (MockedStatic<SecurityUtils> mockedSecurityUtils = mockStatic(SecurityUtils.class)) {
                ...
                // Then
                assertThat(result).isNotNull();
                assertThat(result.recentlyUsedModel().recentlyUsedModelUrl())
                        .isEqualTo(testUser.getRecentlyUsedModelUrl());
                assertThat(result.recentlyUsedModel().recentlyUsedModelName())
