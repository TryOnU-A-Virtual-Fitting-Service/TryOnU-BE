...
class TryOnWriteServiceImplTest extends BaseServiceTest {
    ...
    void setUp() {
        ...
        testCloth = ClothFixture.createClothWithId(1L, Category.TOP);
    ...
    class SaveAndBuildResponse {
        ...
        void saveAndBuildResponse_Success() {
            ...
            given(tryOnResultConverter.toTryOnResultEntity(
                    testCloth, testUser, modelUrl, uploadedResultImageUrl, virtualFittingId, testDefaultModel))
        ...
        void saveAndBuildResponse_Success_NullProductPageUrl() {
            ...
            TryOnResult tryOnResultWithNullUrl = TryOnResultFixture.createTryOnResult(clothWithNullUrl, testUser,
                    testDefaultModel);
            ...
            given(tryOnResultConverter.toTryOnResultEntity(
                    clothWithNullUrl, testUser, modelUrl, uploadedResultImageUrl, virtualFittingId, testDefaultModel))
        ...
        void saveAndBuildResponse_Success_VariousCategories() {
            // Given
            testCategoryProcessing(Category.TOP);
            testCategoryProcessing(Category.BOTTOM);
            testCategoryProcessing(Category.DRESS);
        }

        private void testCategoryProcessing(Category category) {
            // Setup common test data
            String clothImageUrl = "https://test-bucket.s3.amazonaws.com/clothes/test-" + category.name().toLowerCase()
                    + ".jpg";
            ...
            TryOnResult tryOnResult = TryOnResultFixture.createTryOnResult(cloth, testUser, testDefaultModel);
            TryOnResponse expectedResponse = ResponseFixture.createTryOnResponse(
                    1L,
                    uploadedResultImageUrl,
                    testDefaultModel.getId(),
            ...
            given(tryOnResultConverter.toTryOnResultEntity(
                    cloth, testUser, modelUrl, uploadedResultImageUrl, virtualFittingId, testDefaultModel))
